...
location '/tmp/test/20200610/dbgen_version';
...
location '/tmp/test/20200610/customer_address';
...
location '/tmp/test/20200610/customer_demographics';
...
location '/tmp/test/20200610/date_dim';
...
location '/tmp/test/20200610/warehouse';
...
location '/tmp/test/20200610/ship_mode';
...
location '/tmp/test/20200610/time_dim';
...
location '/tmp/test/20200610/reason';
...
location '/tmp/test/20200610/income_band';
...
location '/tmp/test/20200610/item';
...
location '/tmp/test/20200610/store';
...
location '/tmp/test/20200610/call_center';
...
location '/tmp/test/20200610/customer';
...
location '/tmp/test/20200610/web_site';
...
location '/tmp/test/20200610/store_returns';
...
location '/tmp/test/20200610/household_demographics';
...
location '/tmp/test/20200610/web_page';
...
location '/tmp/test/20200610/promotion';
...
location '/tmp/test/20200610/catalog_page';
...
location '/tmp/test/20200610/inventory';
...
location '/tmp/test/20200610/catalog_returns';
...
location '/tmp/test/20200610/web_returns';
...
location '/tmp/test/20200610/web_sales';
...
location '/tmp/test/20200610/catalog_sales';
...
location '/tmp/test/20200610/store_sales';
